...
exports.create = (req, res) => {
    ...
    user
        ...
        .catch(err => {
            res.status(500).send({
                message: err.messge || "Some error occurred while create operation"
            })
        })
}

//retrieve and return all users/ retrive and retrn a single user
...
// Update a user details by user id
exports.update = (req, res) => {
    if (!req.body) {
        return res
            .status(400)
            .send({ messsage: "Data to update can not be empty" })
    }
